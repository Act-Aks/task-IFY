  ...
  return (
    <div className='flex items-center justify-center flex-col'>
      ...
      <div
        ...
        Collaborate, manage and track your projects. From single tasks to complex projects across
        different teams with multiple people. Get ready to easily manage it with Task-IFY.
      </div>

      <Button className='mt-6 bg-gradient-to-r from-fuchsia-600 to-violet-600' size={'lg'} asChild>
